...
// מקלט שידור שמאזין לשינויים בחיבור הרשת ומודיע למשתמש אם אין אינטרנט
public class ConnectionReceiver extends BroadcastReceiver {

    // מופעל אוטומטית בכל שינוי במצב הרשת – בודק אם יש חיבור WiFi או סלולרי ומציג הודעה אם אין
    @Override
